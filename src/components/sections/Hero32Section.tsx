        ...
        slides: [
            {
                ...
                title: 'CINEMATIC EXPERIENCE',
                subtitle: '致力于打造沉浸式的视听盛宴，让每一个像素都讲述精彩故事。',
                btnText: 'u7acbu5373u89c2u770b',
                btnLink: '#'
            }
        ]
    },
    ...
    schema: {
        data: {
            ...
            slides: {
                ...
                label: '视频幻灯片列表',
                itemSchema: {
                    video: { type: 'text', label: '视频地址 (MP4)' },
                    image: { type: 'image', label: '封面/备用图' },
                    title: { type: 'text', label: '大标题' },
                    subtitle: { type: 'text', label: '描述文案' },
