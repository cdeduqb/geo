...
export const ProductList03Section: React.FC<SectionProps> = ({ data, style = {} }) => {
                    ...
                    {products.map((product: any, index) => (
                        ...
                        >
                            ...
                            <div className="rounded-xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.05)' }}>
                                ...
                                <div className="p-6">
                                    <h3 itemProp="name" className="text-xl font-bold mb-2" style={{ color: textColor }}>{product.name}</h3>
                                    <p itemProp="description" className="text-sm opacity-70 mb-4 line-clamp-2" style={{ color: textColor }}>{product.description}</p>
                                    {product.price && (
